...
public class AccountFragment extends Fragment {
    ...
    public void onResume() {
        ...
        listGolf =  (ExpandableListView) view.findViewById(R.id.list_golf);
        ...
        listGolf.setSelection(2);
        listGolf.setSelector(R.color.colorAccent);
    }
